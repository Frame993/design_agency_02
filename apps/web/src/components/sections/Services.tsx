...
export function Services() {
  ...
  return (
    <section
      className="bg-black text-white py-32 px-16"
      id="services"
      ref={ref}
    >
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-20 items-start">
        ...
        <div className="lg:sticky lg:top-[calc(72px+2rem)]">
          <span className="block text-xs font-semibold tracking-[0.12em] uppercase text-accent mb-5">
            {t("services.label")}
          </span>
          <h2
          ...
          >
            {t("services.headline_1")}
            <br />
            {t("services.headline_2")}
            <br />
            {t("services.headline_3")}
          </h2>
          ...
          {data.services.items.map((s, i) => (
            ...
            >
              <div className="flex items-center gap-6 mb-4">
                ...
                <h3 className="text-[1.4rem] font-semibold flex-1 transition-transform duration-300 group-hover:translate-x-1.5">
                  {s.title}
                </h3>
                <span className="text-[1.25rem] text-white/20 transition-all duration-300 group-hover:text-accent group-hover:translate-x-1 group-hover:-translate-y-1">
                  ↗
                </span>
              </div>
              <p className="text-sm text-white/45 leading-[1.8] pl-[calc(24px+1.5rem)] mb-5 max-w-[58ch]">
                {s.desc}
              </p>
