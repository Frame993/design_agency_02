...
const projects = [
  ...
  },
  {
    ...
    svgContent: (_c: string, t: string) => (
      <>
        <path
          d="M0 200 Q150 80 300 200 Q450 320 600 200 Q750 80 900 200 Q1050 320 1200 200"
          stroke="rgba(201,168,245,0.1)"
          strokeWidth="2"
          fill="none"
        />
        <path
          d="M0 200 Q150 120 300 200 Q450 280 600 200 Q750 120 900 200 Q1050 280 1200 200"
          stroke="rgba(201,168,245,0.07)"
          strokeWidth="1"
          fill="none"
        />
        <path
          d="M0 200 Q150 160 300 200 Q450 240 600 200 Q750 160 900 200 Q1050 240 1200 200"
          stroke="rgba(201,168,245,0.05)"
          strokeWidth="1"
          fill="none"
        />
        <text
